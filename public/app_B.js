    ...
    return new Promise(function (resolve, reject) {
        ...
        if (statsHref != null) {
            getData('GET', 'https://www.whoscored.com/Matches/1310236/Betting/Morocco-GNF-1-2018-2019-Raja-Casablanca-MAT-Tetouan').then(function (html) {
                ...
                $('#abc_frame').attr("src", html.URL);

                setTimeout(function(){

                var receiver = document.getElementById('abc_frame').contentWindow;
                receiver.postMessage('hello', 'https://www.betexplorer.com/');
